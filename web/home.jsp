                    ...
                    <div class="listing-content">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><%=Event_Date%></td>
                                <td><%
                                    date3= new SimpleDateFormat("MM/dd/yyyy HH:mm a").parse(EVENT_END);
                                    date1 = new SimpleDateFormat("MM/dd/yyyy HH:mm a").parse(Event_Date);
                                    date2 = Calendar.getInstance().getTime();
                                    int tempdate1=date1.compareTo(date2);
                                    int tempdate2=date2.compareTo(date3);
                                    if ( tempdate1<0 && tempdate2 <0) {
                                        if (status.equals("Quiz") == true) {%>
                                    <button type="Submit" class="btn btn-primary" value=<%=Url + "," + JobID+","+ApplicationId%> name="Quiz" >Quiz</button>
